...
public:
	...
	void input(	int 	resolution,
				...
				bool	doFoam,
				bool	doNormals);
    void doEverything(float uCoord, float vCoord, double result[3], double normals[3], double &foam, double Eigenminus[3], double Eigenplus[3]);
...
//private:
	...
	unsigned long generateUID(float, float);
	void prepareOcean();
	void setupGrid();
